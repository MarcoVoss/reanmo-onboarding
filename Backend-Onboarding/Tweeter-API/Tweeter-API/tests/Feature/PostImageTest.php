...
class PostImageTest extends TestCase
{
    ...
    public function test_store_success()
    {
        ...
        $this->post('/api/posts/1/image', $data)
            ->assertStatus(201);
    }
    ...
    public function test_store_failure_wrong_user()
    {
        ...
        $this->post('/api/posts/10000/image', $data)
            ->assertStatus(404);
    }
    ...
    public function test_store_failure_unauthorized()
    {
        ...
        $this->post('/api/posts/11/image', $data)
            ->assertStatus(403);
    }
    ...
    {
        $this->be(User::find(1));
        $this->get('/api/posts/1000000/image')
            ->assertStatus(404);
    }
    ...
    {
        $this->be(User::find(1));
        $this->delete('/api/posts/1000000/image')
            ->assertStatus(404);
    }
    ...
    {
        $this->be(User::find(1));
        $this->delete('/api/posts/11/image')
            ->assertStatus(403);
    }
